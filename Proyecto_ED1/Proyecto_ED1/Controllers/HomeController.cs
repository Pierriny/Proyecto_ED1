...
namespace Proyecto_ED1.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            Pacientes buscarDPI = new Pacientes();
            buscarDPI.ID = _dpi;
            ...
            {
                Pacientes encontrado = arbolBuscarIDAVL.Find(buscarDPI, new Models.Comparadores.ComparerDPI());
                ViewBag.VehiculoFound = "El Paciente con el DPI/ID " + encontrado.ID + " esta registrado en el sistema ";
                ViewBag.comparaciones = "Se realizaron " + arbolBuscarIDAVL.getComparaciones() + " comparaciones.";
            }
            else
            {
                ViewBag.VehiculoFound = "No se encontró un paciente con tal DPI/ID.";
        ...
        public IActionResult buscarNombre(String _name)
        {
            ...
            {
                ViewBag.VehiculoFound = "No se encontró al Paciente que esta buscando.";
                ViewBag.comparaciones = "";
            }
            return View();
        }
